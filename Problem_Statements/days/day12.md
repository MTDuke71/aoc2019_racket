...
For example, the first example above takes `2772` steps before it repeats a previous state! Here it is again, but with only the first and last states shown:
